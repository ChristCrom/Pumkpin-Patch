  ...
  return (
    <Modal>
      <Card>
        ...
        <p>
          Please Enter Email and Answer the Security Questions to Reset
          Password.
        </p>
        <form onSubmit={submitHandler}>
          ...
          <div>
            <select
              id="1"
              onChange={onChangeQ}
              style={{ width: "800px", fontSize: "1.5rem" }}
            >
          ...
          {selectQuestion1 && (
            <div
              className={`${classes.control} ${
                sec1IsValid === false ? classes.invalid : ""
              }`}
            >
          ...
          {index >= 1 && (
            <div>
              ...
              <div>
                ...
                >
                  {techCompanies.map((option) => (
                    <option id={2} value={option.value}>
                      {option.label}
                    </option>
                  ))}
                </select>
              ...
              {selectQuestion2 && (
                <div
                  className={`${classes.control} ${
                    sec2IsValid === false ? classes.invalid : ""
                  }`}
                >
          ...
          {index >= 2 && (
            <div>
              ...
              {selectQuestion3 && (
                <div
                  className={`${classes.control} ${
                    sec3IsValid === false ? classes.invalid : ""
                  }`}
                >
          ...
          {index >= 3 && (
            <div>
              ...
              {selectQuestion4 && (
                <div
                  className={`${classes.control} ${
                    sec4IsValid === false ? classes.invalid : ""
                  }`}
                >
